...
const AuthenticatedNav = (props: {handleLogout: () => void}) => {
    ...
    return (
        <div className="AuthenticatedNav w-full flex justify-between bg-gray-50 fixed z-50 top-0 left-0 p-4 sm:px-8 shadow-sm dark:bg-gray-900">
            <div className='logo-title flex gap-2 items-center dark:text-gray-400'>
                <svg xmlns="http://www.w3.org/2000/svg" id="Logo" viewBox="0 0 24 24" fill="currentColor" className={`w-5 h-5 sm:mr-auto sm:ml-4`}>
                ...
                <h1 className='font-extrabold'>AVE</h1>
            </div>

            <div className='flex items-center gap-2 dark:text-gray-400'>
                <div id='toggle-darkMode' onClick={() => handleDarkModeToggle()} className='cursor-pointer hover:bg-gray-100 p-2 rounded-full dark:hover:bg-gray-800'>
                    {darkModeState == true? 
                ...
                <button className='log-out flex gap-2 hover-effect md:hover:scale-105' title='Click to Log out' onClick={(e) => {
